  ...
  return (
    <>
        ...
        <main className={stylesInstall.container}>
            ...
            <video src="./images/TutorialAndroid.mp4" autoPlay loop width="250">Video Tutorial Android</video>
            
            <p><BsApple />IOS</p>
            <video src="./images/TutorialiOS.mp4" autoPlay loop width="250">Video Tutorial IOS</video>
        </main>
        <Footer />
    </>
  );
